...
Requires: perl-Library-CallNumber-LC-perl = %{version}-%{release}
...
%package perl
Summary: perl components for the perl-Library-CallNumber-LC package.
Group: Default
Requires: perl-Library-CallNumber-LC = %{version}-%{release}

%description perl
perl components for the perl-Library-CallNumber-LC package.


%prep
%setup -q -n Library-CallNumber-LC-0.23
cd %{_builddir}
tar xf %{_sourcedir}/liblibrary-callnumber-lc-perl_0.23-1.debian.tar.xz
cd %{_builddir}/Library-CallNumber-LC-0.23
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Library-CallNumber-LC-0.23/deblicense/
...
cp %{_builddir}/Library-CallNumber-LC-0.23/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Library-CallNumber-LC/238337817ae08b3c285efb682a7dd938955f73e0
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Library-CallNumber-LC/238337817ae08b3c285efb682a7dd938955f73e0

%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/Library/CallNumber/LC.pm
